...
class LastConnectionDataPage extends StatefulWidget {
  @override
  _ConnectionDataPageState createState() => _ConnectionDataPageState();
}

class _ConnectionDataPageState extends State<LastConnectionDataPage> {
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: _firestore.collection('last').snapshots(),
                            ...
                            return ListTile(
                              subtitle: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'unable to attend : ${doc['unable to attend']}',
                                    style: TextStyle(
                                      color: Colors.green,
                                    ),
                                  )
